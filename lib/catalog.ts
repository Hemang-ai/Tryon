...
export const catalog: Record<CategoryId, CatalogProduct> = {
  ...
  headwear: {
    ...
    imageUrl: "/assets/everyday-cap.jpg", creditUrl: "https://commons.wikimedia.org/wiki/File:Baseball_cap.jpg", credit: "TexasRebel", license: "Public domain",
    variants: standardVariants,
  },
  jewelry: {
    ...
    imageUrl: "/assets/heritage-drops.jpg", creditUrl: "https://commons.wikimedia.org/wiki/File:Earrings_(India),_late_19th_century_(CH_18386847).jpg", credit: "Cooper Hewitt", license: "Public domain",
  ...
  watches: {
    ...
    imageUrl: "/assets/minimal-watch.jpg", creditUrl: "https://commons.wikimedia.org/wiki/File:Wristwatch.jpg", credit: "Wikimedia contributor", license: "Public domain",
    variants: standardVariants,
  },
  bags: {
    ...
    imageUrl: "/assets/heritage-carryall.jpg", creditUrl: "https://commons.wikimedia.org/wiki/File:Belber_Doctor_Bag.jpg", credit: "Sandrine Z", license: "CC BY-SA 4.0", fullBody: true,
    variants: standardVariants,
  },
  shoes: {
    ...
    imageUrl: "/assets/campus-runner.jpg", creditUrl: "https://commons.wikimedia.org/wiki/File:Campus_BlueWhite.jpg", credit: "Prafullkumargoswami", license: "CC BY-SA 4.0", fullBody: true,
    variants: standardVariants,
  },
};
